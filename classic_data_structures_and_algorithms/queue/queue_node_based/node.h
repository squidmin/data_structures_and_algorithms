// FILE: node.h (part of the namespace jamesrmorse)
...
namespace jamesrmorse
{
    ...
    {
    public:
    	node_iterator(node<Item>* initial = 0)
	    { current = initial; }
	Item& operator *( ) const
	    { return current->data( ); }
    ...
    {
    public:
    	const_node_iterator(const node<Item>* initial = 0)
	    { current = initial; }
